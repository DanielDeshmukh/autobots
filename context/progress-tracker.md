...
- [ ] P1 | Inspect impacted code and confirm implementation scope | depends on: none | validation: none | acceptance: Relevant implementation surfaces are narrowed to autobots, project root.
